...
namespace LanguageDailyTraining.Service.Setup
{
    ...
    public class ConfigureSwaggerOptions : IConfigureOptions<SwaggerGenOptions>
    {
        ...
        static OpenApiInfo CreateInfoForApiVersion(ApiVersionDescription description)
        {
            ...
            {
                Title = "API - Language Daily Training",
                Version = description.ApiVersion.ToString(),
                Description = "API for Language Daily Training project.",
                Contact = new OpenApiContact() { Name = "Mateus Almeida Junho", Email = "mateus.junho91@gmail.com" },
